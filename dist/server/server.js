...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nexports.MyList = void 0;\r\nvar react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\r\nfunction MyList(_a) {\r\n    var list = _a.list, onClick = _a.onClick;\r\n    return (react_1.default.createElement(\"ul\", null, list.map(function (item) { return (react_1.default.createElement(\"li\", { onClick: function () { return onClick(item.id); }, key: item.id },\r\n        item.value,\r\n        \" (\",\r\n        item.id,\r\n        \")\")); })));\r\n}\r\nexports.MyList = MyList;\r\n;\r\n\n\n//# sourceURL=webpack:///./src/shared/GenericList/GenericList.tsx?");
